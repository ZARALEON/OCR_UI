...
from OCR_UI import PY2
from OCR_UI import QT5
from OCR_UI import utils
from OCR_UI.config import get_config
from OCR_UI.widgets.main_window_ui import Ui_MainWindow
from OCR_UI.widgets import *
from OCR_UI.utils import *
...
class MainWindow(QMainWindow):
    ...
    def startProcess(self):
        ...
        # 文本检测+识别
        self.processor.set_task(self.filename,cls=True,lan="en")
    ...
    def onMoveShape(self):
        for shape in self.canvas.selectedShapes:
            ...
            self.labelList.selectItem(item)
            self.labelList.scrollToItem(item)
            self.selectRegionId = self.labelList.selectItem(item)
